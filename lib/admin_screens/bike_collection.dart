...
class Bikecollections extends StatefulWidget {
  const Bikecollections({super.key});

  @override
  State<Bikecollections> createState() => _BikecollectionsState();
}

class _BikecollectionsState extends State<Bikecollections> {
  double rating = 0;
