...
class autocollection extends StatefulWidget {
  const autocollection({super.key});

  @override
  State<autocollection> createState() => _autocollectionState();
}

class _autocollectionState extends State<autocollection> {
  double rating = 0;
