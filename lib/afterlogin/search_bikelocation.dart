...
class SearchBikeloc extends StatefulWidget {
  const SearchBikeloc({super.key, required this.docid});
  final String docid;

  @override
  State<SearchBikeloc> createState() => _SearchBikelocState();
}

class _SearchBikelocState extends State<SearchBikeloc> {
