...
class SearchAutoloc extends StatefulWidget {
  const SearchAutoloc({super.key, required this.docid});
  final String docid;

  @override
  State<SearchAutoloc> createState() => _SearchAutolocState();
}

class _SearchAutolocState extends State<SearchAutoloc> {
